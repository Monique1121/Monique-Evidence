# Large Test File 18: list operations
# Arantza Monique Mercado Moreno
# TC2037 - Evidence 2

defmodule LargeLists18 do
  @moduledoc "Large test module 18 for benchmarking parallel syntax highlighting"
  @version "1.0.18"
  @debug false
  @max_value 1000
