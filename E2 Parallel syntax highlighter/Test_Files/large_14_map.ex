# Large Test File 14: map operations
# Arantza Monique Mercado Moreno
# TC2037 - Evidence 2

defmodule LargeMaps14 do
  @moduledoc "Large test module 14 for benchmarking parallel syntax highlighting"
  @version "1.0.14"
  @debug false
  @max_value 1000
