# Large Test File 01: math operations
# Arantza Monique Mercado Moreno
# TC2037 - Evidence 2

defmodule LargeMath01 do
  @moduledoc "Large test module 1 for benchmarking parallel syntax highlighting"
  @version "1.0.1"
  @debug false
  @max_value 1000
