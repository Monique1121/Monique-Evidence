# Large Test File 03: list operations
# Arantza Monique Mercado Moreno
# TC2037 - Evidence 2

defmodule LargeLists03 do
  @moduledoc "Large test module 3 for benchmarking parallel syntax highlighting"
  @version "1.0.3"
  @debug false
  @max_value 1000
