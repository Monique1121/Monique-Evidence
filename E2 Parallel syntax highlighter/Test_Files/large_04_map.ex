# Large Test File 04: map operations
# Arantza Monique Mercado Moreno
# TC2037 - Evidence 2

defmodule LargeMaps04 do
  @moduledoc "Large test module 4 for benchmarking parallel syntax highlighting"
  @version "1.0.4"
  @debug false
  @max_value 1000
