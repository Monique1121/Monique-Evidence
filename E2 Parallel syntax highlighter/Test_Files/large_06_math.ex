# Large Test File 06: math operations
# Arantza Monique Mercado Moreno
# TC2037 - Evidence 2

defmodule LargeMath06 do
  @moduledoc "Large test module 6 for benchmarking parallel syntax highlighting"
  @version "1.0.6"
  @debug false
  @max_value 1000
