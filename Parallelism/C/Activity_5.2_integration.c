...
typedef double (*integration_function_t)(long, int);

// Function declaration
double numIntegration(long n, int threads);
void timeFunction(integration_function_t fun, long n, int threads);
...
int main(int argc, char * argv[])
{
    ...
    timeFunction(numIntegration, n, 1);
...
void timeFunction(integration_function_t fun, long n, int threads)
{
    ...
    */
    ...
    printf("N: %ld | Result: %.20f | Time: %lf | CPU: %lf\n", n, result, elapsed_wall, elapsed_cpu);
}
